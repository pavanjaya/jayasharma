  ...
  return (
    <footer className="mt-auto bg-surface">
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
            ...
            <div className="mt-5 flex items-center gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center border border-neutral-300 text-neutral-500 transition-colors hover:border-[var(--color-navy)] hover:text-[var(--color-navy)]"
                >
                  <social.icon size={16} />
                </a>
              ))}
        ...
        <p className="mt-4 text-xs text-neutral-400">Designed &amp; Developed by Hueness</p>
      </div>
    </footer>
  );
}
