        ...
        >
          ...
          >
            <button
              ...
              onClick={handleClose}
              aria-label="Close"
              className="absolute right-6 top-6 text-[#3d0b3d] transition-colors duration-300 hover:text-[var(--color-navy)]"
            >
              <X size={20} />
            </button>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="grid gap-x-6 gap-y-6 sm:grid-cols-2">
                    <div>
                      <label htmlFor="booking-name" className="mb-1.5 block text-sm font-medium text-[#3d0b3d]">
                        Full Name
                      </label>
                      <input
                        id="booking-name"
                    ...
                    <div>
                      <label htmlFor="booking-phone" className="mb-1.5 block text-sm font-medium text-[#3d0b3d]">
                        Phone Number
                      </label>
                      <input
                        id="booking-phone"
                  ...
                  <div>
                    <label htmlFor="booking-email" className="mb-1.5 block text-sm font-medium text-[#3d0b3d]">
                      Email Address
                    </label>
                    <input
                      id="booking-email"
                  ...
                  <div>
                    <label htmlFor="booking-practice-area" className="mb-1.5 block text-sm font-medium text-[#3d0b3d]">
                      Practice Area
                    </label>
                    <select
                  ...
                  <div className="grid gap-x-6 gap-y-6 sm:grid-cols-2">
                    <div>
                      <label htmlFor="booking-date" className="mb-1.5 block text-sm font-medium text-[#3d0b3d]">
                        Preferred Date
                      </label>
                      <input
                        id="booking-date"
                    ...
                    <div>
                      <label htmlFor="booking-time" className="mb-1.5 block text-sm font-medium text-[#3d0b3d]">
                        Preferred Time
                      </label>
                      <input
                        id="booking-time"
                  ...
                  <div>
                    <label htmlFor="booking-message" className="mb-1.5 block text-sm font-medium text-[#3d0b3d]">
